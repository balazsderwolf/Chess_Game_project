...
public class Kiraly extends Karakter {
    ...
    public boolean validateRequestedMove(int currentLocation_X, int currentLocation_Y, int wantedLocation_X, int wantedLocation_Y, Karakter[][] table, String currentColor) {
        if (currentColor.equals("fekete")) { //x axes+1 because this character can move foreward or attack x axes+1 and y axes +-1
             if ((wantedLocation_X - 1 == currentLocation_X || wantedLocation_X + 1 == currentLocation_X || wantedLocation_X == currentLocation_X) && (wantedLocation_Y - 1 == currentLocation_Y || wantedLocation_Y + 1 == currentLocation_Y || wantedLocation_Y == currentLocation_Y) && !table[wantedLocation_X][wantedLocation_Y].getColor().equals("fekete")) {
                //attack/simple move
                return true;
            }
        } else if (currentColor.equals("feher")) {
            if ((wantedLocation_X - 1 == currentLocation_X || wantedLocation_X + 1 == currentLocation_X || wantedLocation_X == currentLocation_X) && (wantedLocation_Y - 1 == currentLocation_Y || wantedLocation_Y + 1 == currentLocation_Y || wantedLocation_Y == currentLocation_Y) && !table[wantedLocation_X][wantedLocation_Y].getColor().equals("feher")) {
                //attack/simple move
                return true;
            }
        }
